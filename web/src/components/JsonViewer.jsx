...
import { Eye, EyeOff, ChevronDown, ChevronRight, Calendar, FileText, Hash, Copy, Check, AlertCircle } from 'lucide-react'
        ...
        <div>
          <div style={{ 
            ...
            <button
              ...
              aria-label={
                copyStatus === 'success' ? 'JSON copied successfully' :
                copyStatus === 'error' ? 'Failed to copy JSON' :
                copyStatus === 'copying' ? 'Copying JSON...' :
